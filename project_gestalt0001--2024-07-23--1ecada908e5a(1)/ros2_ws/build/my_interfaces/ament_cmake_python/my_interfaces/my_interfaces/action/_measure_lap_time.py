    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime_Goal')
            logger.debug(
...
class Metaclass_MeasureLapTime_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MeasureLapTime_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MeasureLapTime_SendGoal_Request(metaclass=Metaclass_MeasureLapTime_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'my_interfaces/MeasureLapTime_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_interfaces', 'action'], 'MeasureLapTime_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_interfaces.action._measure_lap_time import MeasureLapTime_Goal
...
class Metaclass_MeasureLapTime_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_interfaces.action import _measure_lap_time
...
class MeasureLapTime_SendGoal(metaclass=Metaclass_MeasureLapTime_SendGoal):
    from my_interfaces.action._measure_lap_time import MeasureLapTime_SendGoal_Request as Request
    from my_interfaces.action._measure_lap_time import MeasureLapTime_SendGoal_Response as Response
...
class MeasureLapTime_GetResult_Response(metaclass=Metaclass_MeasureLapTime_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'my_interfaces/MeasureLapTime_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_interfaces', 'action'], 'MeasureLapTime_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_interfaces.action._measure_lap_time import MeasureLapTime_Result
...
class Metaclass_MeasureLapTime_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MeasureLapTime_GetResult(metaclass=Metaclass_MeasureLapTime_GetResult):
    from my_interfaces.action._measure_lap_time import MeasureLapTime_GetResult_Request as Request
    from my_interfaces.action._measure_lap_time import MeasureLapTime_GetResult_Response as Response
...
class Metaclass_MeasureLapTime_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MeasureLapTime_FeedbackMessage(metaclass=Metaclass_MeasureLapTime_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'my_interfaces/MeasureLapTime_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_interfaces', 'action'], 'MeasureLapTime_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from my_interfaces.action._measure_lap_time import MeasureLapTime_Feedback
...
class Metaclass_MeasureLapTime(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interfaces.action.MeasureLapTime')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MeasureLapTime(metaclass=Metaclass_MeasureLapTime):
    ...
    from my_interfaces.action._measure_lap_time import MeasureLapTime_Goal as Goal
    # The result message defined in the action definition.
    from my_interfaces.action._measure_lap_time import MeasureLapTime_Result as Result
    # The feedback message defined in the action definition.
    from my_interfaces.action._measure_lap_time import MeasureLapTime_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from my_interfaces.action._measure_lap_time import MeasureLapTime_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from my_interfaces.action._measure_lap_time import MeasureLapTime_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from my_interfaces.action._measure_lap_time import MeasureLapTime_FeedbackMessage as FeedbackMessage
