...
my_interfaces__action__MeasureLapTime_Goal__create()
{
  ...
  my_interfaces__action__MeasureLapTime_Goal * msg = (my_interfaces__action__MeasureLapTime_Goal *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_Goal));
  bool success = my_interfaces__action__MeasureLapTime_Goal__init(msg);
  if (!success) {
...
my_interfaces__action__MeasureLapTime_Goal__destroy(my_interfaces__action__MeasureLapTime_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_interfaces__action__MeasureLapTime_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_Goal__Sequence__init(my_interfaces__action__MeasureLapTime_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Goal * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_Goal *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_Goal__fini(&data[i - 1]);
      }
...
my_interfaces__action__MeasureLapTime_Goal__Sequence__fini(my_interfaces__action__MeasureLapTime_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Goal__Sequence * array = (my_interfaces__action__MeasureLapTime_Goal__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_Goal__Sequence__init(array, size);
  if (!success) {
...
my_interfaces__action__MeasureLapTime_Goal__Sequence__destroy(my_interfaces__action__MeasureLapTime_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_Goal__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_Goal__Sequence * lhs, const my_interfaces__action__MeasureLapTime_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_Goal * data =
      (my_interfaces__action__MeasureLapTime_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Result * msg = (my_interfaces__action__MeasureLapTime_Result *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_Result));
  bool success = my_interfaces__action__MeasureLapTime_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_Result__destroy(my_interfaces__action__MeasureLapTime_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_interfaces__action__MeasureLapTime_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_Result__Sequence__init(my_interfaces__action__MeasureLapTime_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Result * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_Result *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_Result__Sequence__fini(my_interfaces__action__MeasureLapTime_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Result__Sequence * array = (my_interfaces__action__MeasureLapTime_Result__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_Result__Sequence__destroy(my_interfaces__action__MeasureLapTime_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_Result__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_Result__Sequence * lhs, const my_interfaces__action__MeasureLapTime_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_Result * data =
      (my_interfaces__action__MeasureLapTime_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Feedback * msg = (my_interfaces__action__MeasureLapTime_Feedback *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_Feedback));
  bool success = my_interfaces__action__MeasureLapTime_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_Feedback__destroy(my_interfaces__action__MeasureLapTime_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_interfaces__action__MeasureLapTime_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_Feedback__Sequence__init(my_interfaces__action__MeasureLapTime_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Feedback * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_Feedback *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_Feedback__Sequence__fini(my_interfaces__action__MeasureLapTime_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_Feedback__Sequence * array = (my_interfaces__action__MeasureLapTime_Feedback__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_Feedback__Sequence__destroy(my_interfaces__action__MeasureLapTime_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_Feedback__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_Feedback__Sequence * lhs, const my_interfaces__action__MeasureLapTime_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_Feedback * data =
      (my_interfaces__action__MeasureLapTime_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__init(my_interfaces__action__MeasureLapTime_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_interfaces__action__MeasureLapTime_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!my_interfaces__action__MeasureLapTime_Goal__init(&msg->goal)) {
    my_interfaces__action__MeasureLapTime_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__fini(my_interfaces__action__MeasureLapTime_SendGoal_Request * msg)
{
  ...
  // goal
  my_interfaces__action__MeasureLapTime_Goal__fini(&msg->goal);
}
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__are_equal(const my_interfaces__action__MeasureLapTime_SendGoal_Request * lhs, const my_interfaces__action__MeasureLapTime_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!my_interfaces__action__MeasureLapTime_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_SendGoal_Request * msg = (my_interfaces__action__MeasureLapTime_SendGoal_Request *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Request));
  bool success = my_interfaces__action__MeasureLapTime_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence__init(my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_SendGoal_Request * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_SendGoal_Request *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence__fini(my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * array = (my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence__destroy(my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * lhs, const my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_SendGoal_Request * data =
      (my_interfaces__action__MeasureLapTime_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_interfaces__action__MeasureLapTime_SendGoal_Response__init(my_interfaces__action__MeasureLapTime_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    my_interfaces__action__MeasureLapTime_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_SendGoal_Response * msg = (my_interfaces__action__MeasureLapTime_SendGoal_Response *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Response));
  bool success = my_interfaces__action__MeasureLapTime_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence__init(my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_SendGoal_Response * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_SendGoal_Response *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence__fini(my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * array = (my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence__destroy(my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * lhs, const my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_SendGoal_Response * data =
      (my_interfaces__action__MeasureLapTime_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_interfaces__action__MeasureLapTime_GetResult_Request__init(my_interfaces__action__MeasureLapTime_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_interfaces__action__MeasureLapTime_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_GetResult_Request * msg = (my_interfaces__action__MeasureLapTime_GetResult_Request *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_GetResult_Request));
  bool success = my_interfaces__action__MeasureLapTime_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence__init(my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_GetResult_Request * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_GetResult_Request *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence__fini(my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * array = (my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence__destroy(my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * lhs, const my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_GetResult_Request * data =
      (my_interfaces__action__MeasureLapTime_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_interfaces__action__MeasureLapTime_GetResult_Response__init(my_interfaces__action__MeasureLapTime_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!my_interfaces__action__MeasureLapTime_Result__init(&msg->result)) {
    my_interfaces__action__MeasureLapTime_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
my_interfaces__action__MeasureLapTime_GetResult_Response__fini(my_interfaces__action__MeasureLapTime_GetResult_Response * msg)
{
  ...
  // status
  // result
  my_interfaces__action__MeasureLapTime_Result__fini(&msg->result);
}
...
my_interfaces__action__MeasureLapTime_GetResult_Response__are_equal(const my_interfaces__action__MeasureLapTime_GetResult_Response * lhs, const my_interfaces__action__MeasureLapTime_GetResult_Response * rhs)
{
  ...
  // result
  if (!my_interfaces__action__MeasureLapTime_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_GetResult_Response * msg = (my_interfaces__action__MeasureLapTime_GetResult_Response *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_GetResult_Response));
  bool success = my_interfaces__action__MeasureLapTime_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence__init(my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_GetResult_Response * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_GetResult_Response *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence__fini(my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * array = (my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence__destroy(my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * lhs, const my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_GetResult_Response * data =
      (my_interfaces__action__MeasureLapTime_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__init(my_interfaces__action__MeasureLapTime_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_interfaces__action__MeasureLapTime_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!my_interfaces__action__MeasureLapTime_Feedback__init(&msg->feedback)) {
    my_interfaces__action__MeasureLapTime_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__fini(my_interfaces__action__MeasureLapTime_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  my_interfaces__action__MeasureLapTime_Feedback__fini(&msg->feedback);
}
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__are_equal(const my_interfaces__action__MeasureLapTime_FeedbackMessage * lhs, const my_interfaces__action__MeasureLapTime_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!my_interfaces__action__MeasureLapTime_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_FeedbackMessage * msg = (my_interfaces__action__MeasureLapTime_FeedbackMessage *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_interfaces__action__MeasureLapTime_FeedbackMessage));
  bool success = my_interfaces__action__MeasureLapTime_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence__init(my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_FeedbackMessage * data = NULL;

  if (size) {
    data = (my_interfaces__action__MeasureLapTime_FeedbackMessage *)allocator.zero_allocate(size, sizeof(my_interfaces__action__MeasureLapTime_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_interfaces__action__MeasureLapTime_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_interfaces__action__MeasureLapTime_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence__fini(my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_interfaces__action__MeasureLapTime_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * array = (my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence *)allocator.allocate(sizeof(my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence__destroy(my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence__are_equal(const my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * lhs, const my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_interfaces__action__MeasureLapTime_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_interfaces__action__MeasureLapTime_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_interfaces__action__MeasureLapTime_FeedbackMessage * data =
      (my_interfaces__action__MeasureLapTime_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_interfaces__action__MeasureLapTime_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_interfaces__action__MeasureLapTime_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_interfaces__action__MeasureLapTime_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
